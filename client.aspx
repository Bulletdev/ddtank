<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="client.aspx.cs" Inherits="Tank.Flash._Client" %>
                        ...
                        <tr>
                            <td align="center">
                                <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0"
                                    ...
                                    <embed flashvars="<%=AutoParam %>" src='Loading.swf?<%=Content %>&v=<%=Edition %>&rand=<%=Rand %>' width="1000" height="600"
