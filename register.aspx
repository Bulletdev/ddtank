...
<body style="background: url(../images/popup.png) no-repeat scroll 0pt 0pt transparent;">
   ...
   <table style="width: 100%;">
                             ...
                             <span id="lbError" style="color:Red;" ></span><br />
                                    ...
                                    <tr>
                                        <td class="style8">
                                           <span  style="font-size: 18px; color: #F60; font-weight: bold;">User Name：</span>
                                        </td>
                                        <td class="style9">
                                    ...
                                    <tr>
                                        <td class="style8">
                                           <span  style="font-size: 18px; color: #F60; font-weight: bold;">Password：</span>
                                        </td>
                                        <td class="style9">
                                    ...
                                    <tr>
                                        <td class="style8">
                                           <span  style="font-size: 18px; color: #F60; font-weight: bold;">RePassword：</span></td>
                                        <td class="style9">
                                        ...
                                        <td class="style9">
                                             <table style="width: 27%;">
                                                 <tr>
                                                     ...
                                                     <td>
                                                        <a id="ReLoad" title="" href="javascript:href()" style="font-size: 12px; color: blue">ReLoad</a> </td>
                                                 </tr>
                                             </table>
                                             </td>
                                    </tr>
                                    <tr>
                                        <td class="style11">
                                           <span  style="font-size: 18px; color: #F60; font-weight: bold;">Validate Code：</span>
                                           </td>
                                        <td class="style12">
